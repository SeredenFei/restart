...
## Project Defaults: Weed Detection Literature Work

Inside this repository, default the research scope to:

- agricultural computer vision
- weed detection / weed recognition in field environments
- YOLO-family detectors and nearby baselines
- dataset construction, annotation strategy, and evaluation metrics

Prefer outputs that directly help with:

1. defining a feasible thesis topic
2. writing the related work chapter
3. choosing a baseline and modest improvement direction
4. identifying common datasets, metrics, and experiment patterns

## Local Constraints

- Prefer undergraduate-feasible research questions over frontier-scale claims.
- Prefer structured review output over long report prose unless the user explicitly asks for a full report.
- Surface gaps that can realistically be addressed through dataset quality, lightweight modules, training strategy, or experiment design.
