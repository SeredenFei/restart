...
## Project Defaults: Thesis Defense Deck

Inside this repository, use this skill primarily for a graduation-thesis defense deck.

Default deck emphasis:

1. research background and significance
2. weed-detection task definition
3. dataset source and annotation
4. baseline YOLO model
5. proposed improvement point
6. experiment setup
...
- target length: about 10-15 slides
- audience: advisor and graduation defense panel
- style: clear, conservative, evidence-first
