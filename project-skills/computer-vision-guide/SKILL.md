...
## Project Defaults: YOLO Weed Detection Thesis

When this skill is used in this repository, default to:

- topic: weed detection / weed recognition in field scenes
- main task: object detection
- main model family: YOLO
- comparison scope: YOLOv5, YOLOv8, YOLOv10, RT-DETR when needed
- primary metrics: `mAP@0.5`, `mAP@0.5:0.95`, Precision, Recall, F1

Treat "weed recognition" as object detection unless the user explicitly asks for classification or segmentation.

## Local Output Rules

- Prefer thesis-ready definitions over generic survey prose.
- Make experiment advice feasible for an undergraduate graduation project.
- Prioritize dataset quality, annotation format, baseline fairness, and metric interpretation.
