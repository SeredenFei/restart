...
## Project Defaults: Undergraduate YOLO Thesis

Inside this repository, default to an undergraduate engineering thesis on YOLO-based weed detection.

Preferred chapter logic:

1. Introduction
2. Related technologies and theoretical basis
3. Dataset construction and preprocessing
4. YOLO-based weed detection method
5. Experiment design and result analysis
6. Conclusion and future work

## Local Output Rules

- Do not frame the thesis like a top-tier conference paper.
- Keep contribution claims moderate and defensible.
- Make the dataset and experiment sections concrete enough for graduation review.
- Prefer outlines and section roles before full drafting.
...
For this repository, scale generic thesis advice down to a bachelor's engineering thesis unless the user explicitly asks otherwise.
