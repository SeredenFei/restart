...
## Project Defaults: Model Comparison for Weed Detection

Inside this repository, bias comparisons toward models that help answer:

- why YOLO is a suitable baseline for weed detection
- which YOLO version is realistic for a bachelor's thesis
- what lightweight improvement points are feasible without over-claiming novelty
...
- Compare models, do not just summarize them one by one.
- Separate architecture changes, training strategy changes, and deployment tradeoffs.
- Explicitly flag ideas that are too large for this thesis scope.
